...
int64 nChainStartTime = 1520930390;
...
const string strMessageMagic = "angel Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
	{
        nSubsidy = 69836000 * COIN;
    }
    if(nHeight >1 && nHeight <= 513500*3+1)
    {
        nSubsidy = 8 * COIN;
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in angel
    bool fStrictPayToScriptHash = true; // Always active in angel
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "angel", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector angel empty mapBlockIndex angel angel";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 2993060 : 279540;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0xe273e2622745a27f802eaf003c7d980edd4f0b69472c06fcffb8f006384bd0f7"));
...
unsigned char pchMessageStart[4] = { 0x54, 0x02, 0x77, 0x50 };
